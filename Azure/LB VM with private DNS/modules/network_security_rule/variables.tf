variable "network_security_rule_name" {
  ...
  validation {
    ...
    error_message = "The network_security_rule_name value must match the regex expression '[\\S]+$' (e.g. MaxOffice)"
  }
}
variable "network_security_group_name" {
  ...
  validation {
    ...
    error_message = "The network_security_group_name value must match the regex expression '[\\S]+$' (e.g. MaxOffice)"
  }
}
